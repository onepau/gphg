...
columns=['Brand', 'Model', 'Case', 'Strap', 'Buckle', 'Setting', 'Water resistance', 'Size', 'Thickness', 'Movement', 'Functions', 'Reference', 'Year', 'Collection', 'Price', 'Description', 'Case height']
